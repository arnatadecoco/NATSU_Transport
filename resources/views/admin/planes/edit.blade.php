          ...
          <form class="needs-validation" novalidate action="{{ route('planes.update', $plane->id) }}" method="POST">
            ...
            <div class="row">
              <div class="col-8">
                ...
                <div class="row mb-4">
                  <label for="airline" class="col-sm-3 col-form-label">@lang('PO Bus')</label>
                  <div class="col-sm-9">
                ...
                <div class="row mb-4">
                  <label for="code" class="col-sm-3 col-form-label">@lang('Kode Bus')</label>
                  <div class="col-sm-9">
                ...
                <div class="row mb-4">
                  ...
                  <div class="col-sm-9">
                    <input type="number" min="5" max="50" class="form-control" id="capacity" name="capacity" value="{{ old('capacity', $plane->capacity) }}" required>
                    <div class="valid-feedback">
                      @lang('validation.good')
                    </div>
                    <div class="invalid-feedback">
