          ...
          <form class="needs-validation" novalidate action="{{ route('flights.update', $flight->id) }}" method="POST">
            ...
            <div class="row">
              <div class="col-8">
                ...
                <div class="row mb-4">
                  <label for="loan_limit" class="col-sm-3 col-form-label">Waktu Keberangkatan</label>
                  <div class="col-sm-9">
                ...
                <div class="row mb-4">
                  <label for="loan_limit" class="col-sm-3 col-form-label">Rute</label>
                  <div class="col-sm-9">
                    <div class="row">
                      <div class="col-md-6">
                        <div class="mb-3">
                          <label for="origin" class="col-sm-3 col-form-label">Terminal Keberangkatan</label>
                      ...
                      <div class="col-md-6">
                        <div class="mb-3">
                          <label for="destination" class="col-sm-3 col-form-label">Terminal Tujuan</label>
