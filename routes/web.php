...
Route::group(["prefix" => 'dashboard'], function () {
    Route::group(['middleware' => 'auth'], function () {
        ...
        // --- TAMBAHAN ROUTE UNTUK PEMBAYARAN & PRINT ---
        Route::get('tickets/pay/{id}', [TicketController::class, 'pay'])->name('tickets.pay'); // Halaman Bayar
        Route::post('tickets/process-payment', [TicketController::class, 'processPayment'])->name('tickets.processPayment'); // Proses Bayar
        
        // [BARU] Route untuk Print/Cek Tiket
        Route::get('tickets/print/{id}', [TicketController::class, 'printTicket'])->name('tickets.print'); 
        
        Route::delete('tickets/{id}', [TicketController::class, 'destroy'])->name('tickets.destroy'); // Batal
        // -------------------------------------------------------
